      ...
      <div class="lg:w-full relative">
        ...
        >
          ...
          <div class="hidden lg:block ml-4">
            <p class="text-sm font-bold leading-tight">Ashin Indavudha</p>
            <p class="text-sm leading-tight">@myokhing</p>
          </div>
        ...
        >
          ...
          <div class="w-full">
            <div class="flex items-center w-full">
              <p class="font-semibold">Ashin Indavudha</p>
              <p class="text-sm text-dark ml-2">@myokhing</p>
